...
import com.nam.base.source.code.config.VNPayConfig;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public String createPaymentUrl(OrderResponse orderResponse) throws UnsupportedEncodingException {

        String totalAmount = String.valueOf(orderResponse.getTotal().intValue() * 100);
